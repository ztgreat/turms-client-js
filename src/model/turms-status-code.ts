...
export default class TurmsStatusCode {
    private static _code2ReasonMap = {
        ...
        [Code.DISABLE_FUNCTION]: "The function has been disable in servers",
        [Code.EXPIRY_DATE_BEFORE_NOW]: "The expiry date needs to be after now",
        [Code.EXPIRY_RESOURCE]: "The target resource has expired",
        [Code.ID_DUPLICATED]: "The ID is duplicated",
        [Code.ILLEGAL_ARGUMENTS]: "Illegal arguments",
        [Code.ILLEGAL_DATE_FORMAT]: "The date format is illegal",
        [Code.OWNED_RESOURCE_LIMIT_REACHED]: "The limit of the resource has been reached",
        ...
        [Code.SUCCESSOR_NOT_GROUP_MEMBER]: "The successor is not group member",
        [Code.TARGET_USERS_UNAUTHORIZED]: "The target users are unauthorized",
        [Code.UNAUTHORIZED]: "Unauthorized",
        [Code.LOGGED_DEVICES_CANNOT_OFFLINE]: "Cannot set logged devices offline"
    };
